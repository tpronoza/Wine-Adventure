  ...
  return (
    <Form onSubmit={handleSubmit}>
      ...
      <FloatingLabel controlId="floatingInput2" label="Article Content" className="mb-3">
        <Form.Control type="text" placeholder="Enter Article Content" name="content" value={formInput.wineryName} onChange={handleChange} required />
      </FloatingLabel>
      <FloatingLabel controlId="floatingInput3" label="Wine Artile Image" className="mb-3">
        <Form.Control type="url" placeholder="Enter article image url" name="image" value={formInput.winePicture} onChange={handleChange} required />
      </FloatingLabel>
      <FloatingLabel controlId="floatingInput4" label="Wine Article Link" className="mb-3">
        <Form.Control type="text" placeholder="Enter Wine Article Link" name="articleImage" value={formInput.yearProduced} onChange={handleChange} required />
      </FloatingLabel>
